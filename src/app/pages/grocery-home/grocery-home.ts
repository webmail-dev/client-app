...
import { GroceryContent } from '../../models/content.models';
...
@Component({
  selector: 'app-grocery-home-page',
  imports: [AppSidebar, AppHeader, SearchBar, BottomNav, FilterModal, LocationModal],
  templateUrl: './grocery-home.html',
})
export class GroceryHomePage implements AfterViewInit, OnDestroy {
  ...
  constructor() {
    this.bodyClass.setPageClass('grocery-color');
    this.contentData
      .getGroceryContent()
